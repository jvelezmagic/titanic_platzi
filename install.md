# Titanic Platzi guide installation
...
To move beyond notebook prototyping, all reusable code should go into the `titanic_platzi/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `titanic_platzi` folder and use the modules inside your notebooks :
...
```python
from titanic_platzi.utils.paths import data_dir
data_dir()
```
